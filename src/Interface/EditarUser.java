...
public class EditarUser extends javax.swing.JFrame {
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(ednome, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 299, Short.MAX_VALUE)
                                .addComponent(edsenha, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(nome)
                                .addComponent(senha)))
                        .addGap(50, 50, 50))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        Perfil p = new Perfil();
        p.usuario1 = this.usuario1;
        p.loginj.setText(this.usuario1.getLogin());
        p.nomej.setText(this.usuario1.getNome());
        p.setVisible(true);
        this.dispose();
    ...
    private void edsenhaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_edsenhaActionPerformed
        ...
        daousuario.editarSenha(this.usuario1.getLogin(), this.senha.getText());
        AVISO a = new AVISO();
        a.jLabel1.setText("NOME EDITADO COM MAESTRIA");
        a.setVisible(true);
    ...
    private void ednomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ednomeActionPerformed
       DAOUsuario daousuario = new DAOUsuario();
       daousuario.editarNome(this.usuario1.getLogin(), this.nome.getText());
       AVISO a = new AVISO();
       a.jLabel1.setText("NOME EDITADO COM MAESTRIA");
       a.setVisible(true);
    ...
    private javax.swing.JButton ednome;
    private javax.swing.JButton edsenha;
